(function () {
    ...
    d3.csv("./data/environmental-justice/environmental-justice5.csv")
        .then((data) => {
            ...
            const highlightedCountries = ["Australia", "Belgium", "Canada", "China", "Ethiopia", "France", "Germany", "India", "Japan", "Mali", "Niger", "Nigeria", "South Africa", "Sudan", "UAE", "United States", "United Kingdom"];
