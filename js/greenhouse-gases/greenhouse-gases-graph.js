...
function createPercentChangeChart(compoundName, preIndustryConc, conc2022) {
    ...
    const svg = d3.select('#greenhouse-gases-graph').append('svg')
      ...
      .attr('class', 'percent-change-chart')
    .append('g')
    ...
    const lineX = (x(data[0].name) + x(data[1].name) + x.bandwidth()) / 2;
  ...
  createPercentChangeChart('Carbon dioxide (CO2)', 729, 1923);
  createPercentChangeChart('Methane (CH4)', 729, 1923);
  createPercentChangeChart('Nitrous Oxide (N2O)', 270, 335.8);
  createPercentChangeChart('HFC-32 (CH2F2)', 0, 20);
  createPercentChangeChart('HFC-134a (CF3CH2F)', 0, 108);
  createPercentChangeChart('CFC-11 (CCl3F)', 0, 226);
  createPercentChangeChart('PFC-14 (CF4)', 34, 86);
  createPercentChangeChart('SF6', 0, 9.95);
